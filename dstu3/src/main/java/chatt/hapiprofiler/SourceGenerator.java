...
public class SourceGenerator {
    ...
    private String getInferredFieldType(Element element) {
        ...
        if (numTypes == 0) {
            ...
            fieldType = Reference.class.getSimpleName();
            rootSrc().addImport(Reference.class);
        } else if (numTypes == 1){
            fieldType = types.get(0).getSimpleName();
        } else {
            fieldType = Type.class.getSimpleName();
            rootSrc().addImport(Type.class);
        }
    ...
    private void initClasses() {
        ...
        rootSrc().extendSuperType(DomainResource.class);
